...
public class Q02 {
    ...
    public static void main(String[] args) throws InterruptedException {
        // Set Driver Path
        System.setProperty("webdriver.chome.driver","src/resources/drivers/chromedriver.exe");
        ...
        }else System.out.println("Title does not contain Bootcamps");
        ...
        // Get the title and check if it contains the word "MEDUNNA" and print "Title contains MEDUNNA" or "Title does not contain MEDUNNA"
        String medunnaTitlee =driver.getTitle();
        if (medunnaTitlee.contains("MEDUNNA")){
