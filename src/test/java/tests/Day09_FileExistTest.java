...
//        And verify if that file exist on your computer or not
        String pathOfFile = userHOME + "\\OneDrive\\Masaüstü\\logo.jpeg";//WRITING THE PATH DYNAMICALLY SO TIS PATH CAN WORKS ON OTHER LAPTOPS

        System.out.println(pathOfFile); // C:\Users\emres/Desktop/logo.jpeg
